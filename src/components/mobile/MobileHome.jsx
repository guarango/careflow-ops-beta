...
import { Bell, CheckCircle2, Clock, AlertTriangle, ChevronRight, Play, FileText, Target } from "lucide-react";
...
export default function MobileHome({ user, onNavigate }) {
  ...
  const [activeFlow, setActiveFlow] = useState(null); // "note" | "goal" | "incident" | null
